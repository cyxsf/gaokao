...
import MessageStatusIcon from './mesStatusIcon.vue'
import MessageHeader from './mesHeader'
import MessageFooter from './mesFooter'
import FileElement from '@/components/mesElement/file-element.vue'
import FaceElement from '@/components/mesElement/face-element.vue'
import ImageElement from '@/components/mesElement/image-element.vue'
import TextElement from '@/components/mesElement/text-element.vue'
import GroupTipElement from '@/components/mesElement/group-tip-element.vue'
import GroupSystemNoticeElement from '@/components/mesElement/group-system-notice-element.vue'
import CustomElement from '@/components/mesElement/custom-element.vue'
import GeoElement from '@/components/mesElement/geo-element.vue'
